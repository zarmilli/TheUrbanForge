(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_bbc2f6._.js", {
...
"[project]/app/signup/page.js [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").update({
            name,
        ...
        const { error: couponError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("coupons").insert([
            {
                user_id: user.id,
                code: "NEW25",
                discount: 25,
...
_s(SignupPage, "14c1rdHggJRs1sdnOURW7v4/B+8=", false, function() {
    return [
...
//# sourceMappingURL=_bbc2f6._.js.map